...
export const buildHostSynthesisPrompt = (params: HostPromptParams): string =>
  [
    ...
    "For catalog_details results, write a compact mini descrição in Portuguese with brand, indication, package size and the item's attributes.description. Do not repeat only the card subtitle or price.",
