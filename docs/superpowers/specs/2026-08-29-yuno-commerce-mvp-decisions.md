...
**Date:** 2026-08-29  
**Scope:** This document records *why* we chose specific implementation shortcuts for the hackathon MVP, and what the “market/scale” version would look like.
...
### Decision (MVP / hackathon)
Keep the current Better‑T‑Stack scaffold and **copy the AI addon patterns** from the reference project:
`/Users/isaque/Development/better-t-stack-with-ai`
